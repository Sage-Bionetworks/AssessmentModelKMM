...
//    }
    ...
    fun testButtonAction_Equality() {
        ...
        assertTrue(set.contains(ButtonAction.Navigation.Pause))
        ...
        naviationActions.forEach {
            val obj2 = ButtonAction.valueOf(it.name.uppercase())
        ...
        assertEquals(ButtonAction.Navigation.Pause, ButtonAction.Navigation.valueOf("Pause"))
