...
interface Node : ResultMapElement {
     ...
     */
    fun unpack(moduleInfoProvider: ModuleInfoProvider, resourceInfo: ResourceInfo, jsonCoder: Json): Node = this
...
interface ContentNode : Node {
    ...
    override fun unpack(moduleInfoProvider: ModuleInfoProvider, resourceInfo: ResourceInfo, jsonCoder: Json): Node {
        ...
        return super.unpack(moduleInfoProvider, resourceInfo, jsonCoder)
    }
}
