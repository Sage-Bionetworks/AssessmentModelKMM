...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PermissionType.StandardLocationWhenInUse")))
@interface AssessmentModelPermissionTypeStandardLocationWhenInUse : AssessmentModelPermissionTypeStandard
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)locationWhenInUse __attribute__((swift_name("init()")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PermissionType.StandardNotifications")))
@interface AssessmentModelPermissionTypeStandardNotifications : AssessmentModelPermissionTypeStandard
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PermissionStepObject")))
@interface AssessmentModelPermissionStepObject : AssessmentModelStepObject <AssessmentModelPermissionStep, AssessmentModelPermissionInfo>
- (instancetype)initWithIdentifier:(NSString *)identifier permissionType:(AssessmentModelPermissionType *)permissionType imageInfo:(id<AssessmentModelImageInfo> _Nullable)imageInfo optional:(BOOL)optional requiresBackground:(BOOL)requiresBackground reason:(NSString * _Nullable)reason restrictedMessage:(NSString * _Nullable)restrictedMessage deniedMessage:(NSString * _Nullable)deniedMessage __attribute__((swift_name("init(identifier:permissionType:imageInfo:optional:requiresBackground:reason:restrictedMessage:deniedMessage:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (AssessmentModelPermissionType *)component2 __attribute__((swift_name("component2()")));
...
- (NSString * _Nullable)component7 __attribute__((swift_name("component7()")));
- (NSString * _Nullable)component8 __attribute__((swift_name("component8()")));
- (AssessmentModelPermissionStepObject *)doCopyIdentifier:(NSString *)identifier permissionType:(AssessmentModelPermissionType *)permissionType imageInfo:(id<AssessmentModelImageInfo> _Nullable)imageInfo optional:(BOOL)optional requiresBackground:(BOOL)requiresBackground reason:(NSString * _Nullable)reason restrictedMessage:(NSString * _Nullable)restrictedMessage deniedMessage:(NSString * _Nullable)deniedMessage __attribute__((swift_name("doCopy(identifier:permissionType:imageInfo:optional:requiresBackground:reason:restrictedMessage:deniedMessage:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable deniedMessage __attribute__((swift_name("deniedMessage")));
...
@property (readonly) BOOL optional __attribute__((swift_name("optional")));
@property (readonly) AssessmentModelPermissionType *permissionType __attribute__((swift_name("permissionType")));
@property (readonly) NSArray<id<AssessmentModelPermissionInfo>> *permissions __attribute__((swift_name("permissions")));
@property (readonly) NSString * _Nullable reason __attribute__((swift_name("reason")));
@property (readonly) BOOL requiresBackground __attribute__((swift_name("requiresBackground")));
@property (readonly) NSString * _Nullable restrictedMessage __attribute__((swift_name("restrictedMessage")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PermissionStepObject.Companion")))
@interface AssessmentModelPermissionStepObjectCompanion : AssessmentModelBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<AssessmentModelKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
