...
@required
- (id<AssessmentModelNode>)unpackFileLoader:(id<AssessmentModelFileLoader>)fileLoader resourceInfo:(id<AssessmentModelResourceInfo>)resourceInfo jsonCoder:(AssessmentModelKotlinx_serialization_runtimeJson *)jsonCoder __attribute__((swift_name("unpack(fileLoader:resourceInfo:jsonCoder:)")));
...
- (int32_t)compareToOther:(AssessmentModelActiveStepCommand *)other __attribute__((swift_name("compareTo(other:)")));
@end;
...
@property AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable jsonValue __attribute__((swift_name("jsonValue")));
@end;
...
@protocol AssessmentModelKotlinx_serialization_runtimeSerializationStrategy
@required
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(id _Nullable)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;

__attribute__((swift_name("Kotlinx_serialization_runtimeDeserializationStrategy")))
@protocol AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy
@required
- (id _Nullable)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (id _Nullable)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(id _Nullable)old __attribute__((swift_name("patch(decoder:old:)")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;

__attribute__((swift_name("Kotlinx_serialization_runtimeKSerializer")))
@protocol AssessmentModelKotlinx_serialization_runtimeKSerializer <AssessmentModelKotlinx_serialization_runtimeSerializationStrategy, AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>
@required
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ButtonAction.Companion")))
@interface AssessmentModelButtonActionCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelButtonAction *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelButtonAction *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelButtonAction *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelButtonAction *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelButtonActionNavigation * _Nullable)valueOfName:(NSString *)name __attribute__((swift_name("valueOf(name:)")));
...
@interface AssessmentModelPermissionTypeCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelPermissionType *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelPermissionType *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelPermissionType *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelPermissionType *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelPermissionTypeStandard * _Nullable)valueOfName:(NSString *)name __attribute__((swift_name("valueOf(name:)")));
...
@interface AssessmentModelSpokenInstructionTimingCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelSpokenInstructionTiming *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelSpokenInstructionTiming *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelSpokenInstructionTiming *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelSpokenInstructionTiming *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (BOOL)saveAnswerAnswer:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)answer forItem:(id<AssessmentModelInputItemState>)forItem __attribute__((swift_name("saveAnswer(answer:forItem:)")));
...
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (BOOL)allAnswersValid __attribute__((swift_name("allAnswersValid()")));
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)answerForIndex:(int32_t)index inputItem:(id<AssessmentModelInputItem>)inputItem __attribute__((swift_name("answerFor(index:inputItem:)")));
- (BOOL)didChangeSelectionStateSelected:(BOOL)selected forItem:(id<AssessmentModelChoiceInputItemState>)forItem __attribute__((swift_name("didChangeSelectionState(selected:forItem:)")));
...
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValueForMap:(NSDictionary<NSString *, AssessmentModelKotlinx_serialization_runtimeJsonElement *> *)forMap __attribute__((swift_name("jsonValue(forMap:)")));
- (BOOL)saveAnswerAnswer:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)answer forItem:(id<AssessmentModelInputItemState>)forItem __attribute__((swift_name("saveAnswer(answer:forItem:)")));
...
- (AssessmentModelKotlinx_serialization_runtimeJsonElement *)jsonElementForValue:(id)value __attribute__((swift_name("jsonElementFor(value:)")));
@property (readonly) AssessmentModelBaseType *baseType __attribute__((swift_name("baseType")));
@property (readonly) AssessmentModelKotlinx_serialization_runtimeSerialKind *serialKind __attribute__((swift_name("serialKind")));
@end;
...
@required
@property AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable currentAnswer __attribute__((swift_name("currentAnswer")));
@property (readonly) int32_t index __attribute__((swift_name("index")));
...
@required
@property AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable storedAnswer __attribute__((swift_name("storedAnswer")));
@end;
...
- (instancetype)initWithIndex:(int32_t)index inputItem:(id<AssessmentModelInputItem>)inputItem storedAnswer:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)storedAnswer __attribute__((swift_name("init(index:inputItem:storedAnswer:)"))) __attribute__((objc_designated_initializer));
@property (readonly) int32_t index __attribute__((swift_name("index")));
@property (readonly) id<AssessmentModelInputItem> inputItem __attribute__((swift_name("inputItem")));
@property BOOL selected __attribute__((swift_name("selected")));
@property AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable storedAnswer __attribute__((swift_name("storedAnswer")));
...
- (int32_t)compareToOther:(AssessmentModelAutoCapitalizationType *)other __attribute__((swift_name("compareTo(other:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AutoCapitalizationType.Companion")))
@interface AssessmentModelAutoCapitalizationTypeCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelAutoCapitalizationType *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelAutoCapitalizationType *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelAutoCapitalizationType *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelAutoCapitalizationType *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (int32_t)compareToOther:(AssessmentModelAutoCorrectionType *)other __attribute__((swift_name("compareTo(other:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AutoCorrectionType.Companion")))
@interface AssessmentModelAutoCorrectionTypeCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelAutoCorrectionType *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelAutoCorrectionType *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelAutoCorrectionType *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelAutoCorrectionType *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (int32_t)compareToOther:(AssessmentModelBaseType *)other __attribute__((swift_name("compareTo(other:)")));
- (AssessmentModelKotlinx_serialization_runtimeJsonElement *)jsonElementForValue:(id)value __attribute__((swift_name("jsonElementFor(value:)")));
@property (readonly) AssessmentModelKotlinx_serialization_runtimeSerialKind *serialKind __attribute__((swift_name("serialKind")));
@end;
...
@interface AssessmentModelBaseTypeCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelBaseType *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelBaseType *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelBaseType *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelBaseType *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
@required
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValueSelected:(BOOL)selected __attribute__((swift_name("jsonValue(selected:)")));
@property (readonly) NSString * _Nullable detail __attribute__((swift_name("detail")));
@property (readonly) BOOL exclusive __attribute__((swift_name("exclusive")));
@property (readonly) NSString * _Nullable fieldLabel __attribute__((swift_name("fieldLabel")));
...
@property (readonly) AssessmentModelKotlinx_serialization_runtimeJsonElement *matchingAnswer __attribute__((swift_name("matchingAnswer")));
...
@interface AssessmentModelInvalidMessageObjectCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelInvalidMessageObject *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelInvalidMessageObject *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelInvalidMessageObject *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelInvalidMessageObject *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (instancetype)initWithIndex:(int32_t)index inputItem:(id<AssessmentModelKeyboardTextInputItem>)inputItem storedAnswer:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)storedAnswer __attribute__((swift_name("init(index:inputItem:storedAnswer:)"))) __attribute__((objc_designated_initializer));
@property (readonly) int32_t index __attribute__((swift_name("index")));
...
- (int32_t)compareToOther:(AssessmentModelKeyboardType *)other __attribute__((swift_name("compareTo(other:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KeyboardType.Companion")))
@interface AssessmentModelKeyboardTypeCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelKeyboardType *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelKeyboardType *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelKeyboardType *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelKeyboardType *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (int32_t)compareToOther:(AssessmentModelNumberType *)other __attribute__((swift_name("compareTo(other:)")));
@end;

__attribute__((swift_name("TextValidator")))
@protocol AssessmentModelTextValidator
@required
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValueForValue:(id _Nullable)value __attribute__((swift_name("jsonValueFor(value:)")));
...
- (id _Nullable)valueForJsonValue:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValue __attribute__((swift_name("valueFor(jsonValue:)")));
@end;
...
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValueForValue:(NSString * _Nullable)value __attribute__((swift_name("jsonValueFor(value:)")));
...
- (NSString * _Nullable)valueForJsonValue:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValue __attribute__((swift_name("valueFor(jsonValue:)")));
@end;
...
- (int32_t)compareToOther:(AssessmentModelReservedNavigationIdentifier *)other __attribute__((swift_name("compareTo(other:)")));
...
@required
@property (readonly) AssessmentModelKotlinx_serialization_runtimeJsonElement *value __attribute__((swift_name("value")));
@end;
...
- (int32_t)compareToOther:(AssessmentModelSpellCheckingType *)other __attribute__((swift_name("compareTo(other:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SpellCheckingType.Companion")))
@interface AssessmentModelSpellCheckingTypeCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelSpellCheckingType *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelSpellCheckingType *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelSpellCheckingType *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelSpellCheckingType *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (int32_t)compareToOther:(AssessmentModelSurveyRuleOperator *)other __attribute__((swift_name("compareTo(other:)")));
@end;
...
@interface AssessmentModelUIHintChoiceCompanion : AssessmentModelBase <AssessmentModelStringEnumCompanion, AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelUIHintChoice *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelUIHintChoice *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelUIHintChoice *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelUIHintChoice *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (AssessmentModelUIHintChoice * _Nullable)valueOfName:(NSString *)name __attribute__((swift_name("valueOf(name:)")));
...
@interface AssessmentModelUIHintCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelUIHint *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelUIHint *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelUIHint *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelUIHint *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelUIHintDetail * _Nullable)valueOfName:(NSString *)name __attribute__((swift_name("valueOf(name:)")));
...
@interface AssessmentModelUIHintTextFieldCompanion : AssessmentModelBase <AssessmentModelStringEnumCompanion, AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelUIHintTextField *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelUIHintTextField *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelUIHintTextField *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelUIHintTextField *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (AssessmentModelUIHintTextField * _Nullable)valueOfName:(NSString *)name __attribute__((swift_name("valueOf(name:)")));
...
- (int32_t)compareToOther:(AssessmentModelAttitudeReferenceFrame *)other __attribute__((swift_name("compareTo(other:)")));
@end;
...
- (instancetype)initWithIdentifier:(NSString *)identifier resultIdentifier:(NSString * _Nullable)resultIdentifier comment:(NSString * _Nullable)comment reason:(NSString * _Nullable)reason optional:(BOOL)optional motionStepIdentifier:(NSString * _Nullable)motionStepIdentifier startStepIdentifier:(NSString * _Nullable)startStepIdentifier stopStepIdentifier:(NSString * _Nullable)stopStepIdentifier shouldDeletePrevious:(BOOL)shouldDeletePrevious usesCSVEncoding:(BOOL)usesCSVEncoding __attribute__((swift_name("init(identifier:resultIdentifier:comment:reason:optional:motionStepIdentifier:startStepIdentifier:stopStepIdentifier:shouldDeletePrevious:usesCSVEncoding:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (AssessmentModelDistanceRecorderConfiguration *)doCopyIdentifier:(NSString *)identifier resultIdentifier:(NSString * _Nullable)resultIdentifier comment:(NSString * _Nullable)comment reason:(NSString * _Nullable)reason optional:(BOOL)optional motionStepIdentifier:(NSString * _Nullable)motionStepIdentifier startStepIdentifier:(NSString * _Nullable)startStepIdentifier stopStepIdentifier:(NSString * _Nullable)stopStepIdentifier shouldDeletePrevious:(BOOL)shouldDeletePrevious usesCSVEncoding:(BOOL)usesCSVEncoding __attribute__((swift_name("doCopy(identifier:resultIdentifier:comment:reason:optional:motionStepIdentifier:startStepIdentifier:stopStepIdentifier:shouldDeletePrevious:usesCSVEncoding:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable comment __attribute__((swift_name("comment")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier resultIdentifier:(NSString * _Nullable)resultIdentifier comment:(NSString * _Nullable)comment reason:(NSString * _Nullable)reason optional:(BOOL)optional startStepIdentifier:(NSString * _Nullable)startStepIdentifier stopStepIdentifier:(NSString * _Nullable)stopStepIdentifier requiresBackground:(BOOL)requiresBackground shouldDeletePrevious:(BOOL)shouldDeletePrevious usesCSVEncoding:(BOOL)usesCSVEncoding recorderTypes:(NSSet<AssessmentModelMotionRecorderType *> *)recorderTypes samplingFrequency:(AssessmentModelDouble * _Nullable)samplingFrequency __attribute__((swift_name("init(identifier:resultIdentifier:comment:reason:optional:startStepIdentifier:stopStepIdentifier:requiresBackground:shouldDeletePrevious:usesCSVEncoding:recorderTypes:samplingFrequency:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (BOOL)component10 __attribute__((swift_name("component10()")));
- (NSSet<AssessmentModelMotionRecorderType *> *)component11 __attribute__((swift_name("component11()")));
- (AssessmentModelDouble * _Nullable)component12 __attribute__((swift_name("component12()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
...
- (BOOL)component9 __attribute__((swift_name("component9()")));
- (AssessmentModelMotionRecorderConfiguration *)doCopyIdentifier:(NSString *)identifier resultIdentifier:(NSString * _Nullable)resultIdentifier comment:(NSString * _Nullable)comment reason:(NSString * _Nullable)reason optional:(BOOL)optional startStepIdentifier:(NSString * _Nullable)startStepIdentifier stopStepIdentifier:(NSString * _Nullable)stopStepIdentifier requiresBackground:(BOOL)requiresBackground shouldDeletePrevious:(BOOL)shouldDeletePrevious usesCSVEncoding:(BOOL)usesCSVEncoding recorderTypes:(NSSet<AssessmentModelMotionRecorderType *> *)recorderTypes samplingFrequency:(AssessmentModelDouble * _Nullable)samplingFrequency __attribute__((swift_name("doCopy(identifier:resultIdentifier:comment:reason:optional:startStepIdentifier:stopStepIdentifier:requiresBackground:shouldDeletePrevious:usesCSVEncoding:recorderTypes:samplingFrequency:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable comment __attribute__((swift_name("comment")));
...
- (int32_t)compareToOther:(AssessmentModelMotionRecorderType *)other __attribute__((swift_name("compareTo(other:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MotionRecorderType.Companion")))
@interface AssessmentModelMotionRecorderTypeCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelMotionRecorderType *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelMotionRecorderType *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelMotionRecorderType *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelMotionRecorderType *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier duration:(double)duration resultIdentifier:(NSString * _Nullable)resultIdentifier __attribute__((swift_name("init(identifier:duration:resultIdentifier:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (double)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (AssessmentModelActiveStepObject *)doCopyIdentifier:(NSString *)identifier duration:(double)duration resultIdentifier:(NSString * _Nullable)resultIdentifier __attribute__((swift_name("doCopy(identifier:duration:resultIdentifier:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) double duration __attribute__((swift_name("duration")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier answerType:(AssessmentModelAnswerType * _Nullable)answerType jsonValue:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValue startDateString:(NSString *)startDateString endDateString:(NSString * _Nullable)endDateString __attribute__((swift_name("init(identifier:answerType:jsonValue:startDateString:endDateString:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (AssessmentModelAnswerType * _Nullable)component2 __attribute__((swift_name("component2()")));
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)component3 __attribute__((swift_name("component3()")));
...
- (id<AssessmentModelAssessment> _Nullable)decodeObjectAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("decodeObject()")));
- (id<AssessmentModelNavigator>)getNavigator __attribute__((swift_name("getNavigator()")));
- (id<AssessmentModelAssessment>)unpackFileLoader:(id<AssessmentModelFileLoader>)fileLoader resourceInfo:(id<AssessmentModelResourceInfo>)resourceInfo jsonCoder:(AssessmentModelKotlinx_serialization_runtimeJson *)jsonCoder __attribute__((swift_name("unpack(fileLoader:resourceInfo:jsonCoder:)")));
@property (readonly) NSDictionary<AssessmentModelButtonAction *, id<AssessmentModelButtonActionInfo>> *buttonMap __attribute__((swift_name("buttonMap")));
@property (readonly) NSString * _Nullable comment __attribute__((swift_name("comment")));
@property (readonly) NSString * _Nullable detail __attribute__((swift_name("detail")));
@property (readonly) int32_t estimatedMinutes __attribute__((swift_name("estimatedMinutes")));
...
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)doCopyFromOriginal:(id<AssessmentModelContentNode>)original __attribute__((swift_name("doCopyFrom(original:)")));
- (id<AssessmentModelBranchNodeResult>)createResult __attribute__((swift_name("createResult()")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier children:(NSArray<id<AssessmentModelNode>> *)children versionString:(NSString * _Nullable)versionString resultIdentifier:(NSString * _Nullable)resultIdentifier estimatedMinutes:(int32_t)estimatedMinutes backgroundActions:(NSArray<id<AssessmentModelAsyncActionConfiguration>> *)backgroundActions __attribute__((swift_name("init(identifier:children:versionString:resultIdentifier:estimatedMinutes:backgroundActions:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (AssessmentModelAssessmentObject *)doCopyIdentifier:(NSString *)identifier children:(NSArray<id<AssessmentModelNode>> *)children versionString:(NSString * _Nullable)versionString resultIdentifier:(NSString * _Nullable)resultIdentifier estimatedMinutes:(int32_t)estimatedMinutes backgroundActions:(NSArray<id<AssessmentModelAsyncActionConfiguration>> *)backgroundActions __attribute__((swift_name("doCopy(identifier:children:versionString:resultIdentifier:estimatedMinutes:backgroundActions:)")));
- (id<AssessmentModelAssessmentResult>)createResult __attribute__((swift_name("createResult()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (AssessmentModelAssessmentObject *)unpackFileLoader:(id<AssessmentModelFileLoader>)fileLoader resourceInfo:(id<AssessmentModelResourceInfo>)resourceInfo jsonCoder:(AssessmentModelKotlinx_serialization_runtimeJson *)jsonCoder __attribute__((swift_name("unpack(fileLoader:resourceInfo:jsonCoder:)")));
@property (readonly) NSArray<id<AssessmentModelAsyncActionConfiguration>> *backgroundActions __attribute__((swift_name("backgroundActions")));
@property (readonly) NSArray<id<AssessmentModelNode>> *children __attribute__((swift_name("children")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier versionString:(NSString * _Nullable)versionString pathHistoryResults:(NSMutableArray<id<AssessmentModelResult>> *)pathHistoryResults inputResults:(AssessmentModelMutableSet<id<AssessmentModelResult>> *)inputResults runUUIDString:(NSString *)runUUIDString startDateString:(NSString *)startDateString endDateString:(NSString * _Nullable)endDateString path:(NSMutableArray<AssessmentModelPathMarker *> *)path nextNodeIdentifier:(NSString * _Nullable)nextNodeIdentifier __attribute__((swift_name("init(identifier:versionString:pathHistoryResults:inputResults:runUUIDString:startDateString:endDateString:path:nextNodeIdentifier:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSMutableArray<id<AssessmentModelResult>> *)component3 __attribute__((swift_name("component3()")));
- (AssessmentModelMutableSet<id<AssessmentModelResult>> *)component4 __attribute__((swift_name("component4()")));
- (NSString *)component5 __attribute__((swift_name("component5()")));
- (NSString *)component6 __attribute__((swift_name("component6()")));
- (NSString * _Nullable)component7 __attribute__((swift_name("component7()")));
- (NSMutableArray<AssessmentModelPathMarker *> *)component8 __attribute__((swift_name("component8()")));
- (NSString * _Nullable)component9 __attribute__((swift_name("component9()")));
- (AssessmentModelAssessmentResultObject *)doCopyIdentifier:(NSString *)identifier versionString:(NSString * _Nullable)versionString pathHistoryResults:(NSMutableArray<id<AssessmentModelResult>> *)pathHistoryResults inputResults:(AssessmentModelMutableSet<id<AssessmentModelResult>> *)inputResults runUUIDString:(NSString *)runUUIDString startDateString:(NSString *)startDateString endDateString:(NSString * _Nullable)endDateString path:(NSMutableArray<AssessmentModelPathMarker *> *)path nextNodeIdentifier:(NSString * _Nullable)nextNodeIdentifier __attribute__((swift_name("doCopy(identifier:versionString:pathHistoryResults:inputResults:runUUIDString:startDateString:endDateString:path:nextNodeIdentifier:)")));
...
- (NSString * _Nullable)component5 __attribute__((swift_name("component5()")));
- (AssessmentModelChoiceOptionObject *)doCopyValue:(AssessmentModelKotlinx_serialization_runtimeJsonElement *)value fieldLabel:(NSString * _Nullable)fieldLabel icon:(AssessmentModelFetchableImage * _Nullable)icon exclusive:(BOOL)exclusive detail:(NSString * _Nullable)detail __attribute__((swift_name("doCopy(value:fieldLabel:icon:exclusive:detail:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValueSelected:(BOOL)selected __attribute__((swift_name("jsonValue(selected:)")));
- (NSString *)description __attribute__((swift_name("description()")));
...
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)doCopyFromOriginal:(id<AssessmentModelContentNode>)original __attribute__((swift_name("doCopyFrom(original:)")));
- (id<AssessmentModelAnswerResult>)createResult __attribute__((swift_name("createResult()")));
@property id<AssessmentModelImageInfo> _Nullable imageInfo __attribute__((swift_name("imageInfo")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier choices:(NSArray<AssessmentModelChoiceOptionObject *> *)choices baseType:(AssessmentModelBaseType *)baseType resultIdentifier:(NSString * _Nullable)resultIdentifier singleAnswer:(BOOL)singleAnswer uiHint:(AssessmentModelUIHint *)uiHint __attribute__((swift_name("init(identifier:choices:baseType:resultIdentifier:singleAnswer:uiHint:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (BOOL)component5 __attribute__((swift_name("component5()")));
- (AssessmentModelUIHint *)component6 __attribute__((swift_name("component6()")));
- (AssessmentModelChoiceQuestionObject *)doCopyIdentifier:(NSString *)identifier choices:(NSArray<AssessmentModelChoiceOptionObject *> *)choices baseType:(AssessmentModelBaseType *)baseType resultIdentifier:(NSString * _Nullable)resultIdentifier singleAnswer:(BOOL)singleAnswer uiHint:(AssessmentModelUIHint *)uiHint __attribute__((swift_name("doCopy(identifier:choices:baseType:resultIdentifier:singleAnswer:uiHint:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) AssessmentModelBaseType *baseType __attribute__((swift_name("baseType")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier choices:(NSArray<AssessmentModelChoiceOptionObject *> *)choices otherInputItem:(id<AssessmentModelInputItem>)otherInputItem resultIdentifier:(NSString * _Nullable)resultIdentifier singleAnswer:(BOOL)singleAnswer uiHint:(AssessmentModelUIHint *)uiHint __attribute__((swift_name("init(identifier:choices:otherInputItem:resultIdentifier:singleAnswer:uiHint:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSArray<AssessmentModelChoiceOptionObject *> *)component2 __attribute__((swift_name("component2()")));
...
- (AssessmentModelComparableSurveyRuleObject *)doCopyMatchingAnswer:(AssessmentModelKotlinx_serialization_runtimeJsonElement *)matchingAnswer skipToIdentifier:(NSString * _Nullable)skipToIdentifier ruleOperator:(AssessmentModelSurveyRuleOperator * _Nullable)ruleOperator accuracy:(double)accuracy __attribute__((swift_name("doCopy(matchingAnswer:skipToIdentifier:ruleOperator:accuracy:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) double accuracy __attribute__((swift_name("accuracy")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier duration:(double)duration resultIdentifier:(NSString * _Nullable)resultIdentifier fullInstructionsOnly:(BOOL)fullInstructionsOnly __attribute__((swift_name("init(identifier:duration:resultIdentifier:fullInstructionsOnly:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (double)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (BOOL)component4 __attribute__((swift_name("component4()")));
- (AssessmentModelCountdownStepObject *)doCopyIdentifier:(NSString *)identifier duration:(double)duration resultIdentifier:(NSString * _Nullable)resultIdentifier fullInstructionsOnly:(BOOL)fullInstructionsOnly __attribute__((swift_name("doCopy(identifier:duration:resultIdentifier:fullInstructionsOnly:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSSet<AssessmentModelActiveStepCommand *> *commands __attribute__((swift_name("commands")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AssessmentModelFormattedValue<T> *)validateNumber:(T _Nullable)number __attribute__((swift_name("validate(number:)")));
...
@property (readonly) T _Nullable maximumValue __attribute__((swift_name("maximumValue")));
@property AssessmentModelInvalidMessageObject * _Nullable minInvalidMessage __attribute__((swift_name("minInvalidMessage")));
@property (readonly) T _Nullable minimumValue __attribute__((swift_name("minimumValue")));
@property (readonly) AssessmentModelNumberFormatOptionsStyle *numberStyle __attribute__((swift_name("numberStyle")));
@property (readonly) T _Nullable stepInterval __attribute__((swift_name("stepInterval")));
...
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (AssessmentModelFormattedValue<AssessmentModelDouble *> *)validateNumber:(AssessmentModelDouble * _Nullable)number __attribute__((swift_name("validate(number:)")));
@property (readonly) int32_t maximumFractionDigits __attribute__((swift_name("maximumFractionDigits")));
...
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValueForValue:(T _Nullable)value __attribute__((swift_name("jsonValueFor(value:)")));
...
- (T _Nullable)valueForJsonValue:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValue __attribute__((swift_name("valueFor(jsonValue:)")));
@end;
...
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValueForValue:(AssessmentModelDouble * _Nullable)value __attribute__((swift_name("jsonValueFor(value:)")));
- (AssessmentModelFormattedValue<NSString *> *)localizedStringForValue:(AssessmentModelDouble * _Nullable)value __attribute__((swift_name("localizedStringFor(value:)")));
...
- (AssessmentModelDouble * _Nullable)valueForJsonValue:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValue __attribute__((swift_name("valueFor(jsonValue:)")));
- (AssessmentModelFormattedValue<AssessmentModelDouble *> * _Nullable)valueForText:(NSString *)text __attribute__((swift_name("valueFor(text:)")));
@end;
...
@property (readonly) AssessmentModelKotlinx_serialization_runtimeJson *jsonCoder __attribute__((swift_name("jsonCoder")));
@end;
...
- (instancetype)initWithIdentifier:(NSString *)identifier resultIdentifier:(NSString * _Nullable)resultIdentifier imageInfo:(id<AssessmentModelImageInfo> _Nullable)imageInfo children:(NSArray<id<AssessmentModelNode>> *)children __attribute__((swift_name("init(identifier:resultIdentifier:imageInfo:children:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (id<AssessmentModelImageInfo> _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSArray<id<AssessmentModelNode>> *)component4 __attribute__((swift_name("component4()")));
- (AssessmentModelFormStepObject *)doCopyIdentifier:(NSString *)identifier resultIdentifier:(NSString * _Nullable)resultIdentifier imageInfo:(id<AssessmentModelImageInfo> _Nullable)imageInfo children:(NSArray<id<AssessmentModelNode>> *)children __attribute__((swift_name("doCopy(identifier:resultIdentifier:imageInfo:children:)")));
- (id<AssessmentModelCollectionResult>)createResult __attribute__((swift_name("createResult()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<id<AssessmentModelNode>> *children __attribute__((swift_name("children")));
...
@interface AssessmentModelImageNameSerializer : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)imageNameSerializer __attribute__((swift_name("init()")));
- (AssessmentModelFetchableImage *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelFetchableImage *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelFetchableImage *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelFetchableImage *)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
@interface AssessmentModelImagePlacementCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelImagePlacement *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelImagePlacement *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelImagePlacement *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelImagePlacement *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelImagePlacementStandard * _Nullable)valueOfName:(NSString *)name __attribute__((swift_name("valueOf(name:)")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier resultIdentifier:(NSString * _Nullable)resultIdentifier imageInfo:(id<AssessmentModelImageInfo> _Nullable)imageInfo fullInstructionsOnly:(BOOL)fullInstructionsOnly __attribute__((swift_name("init(identifier:resultIdentifier:imageInfo:fullInstructionsOnly:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (id<AssessmentModelImageInfo> _Nullable)component3 __attribute__((swift_name("component3()")));
- (BOOL)component4 __attribute__((swift_name("component4()")));
- (AssessmentModelInstructionStepObject *)doCopyIdentifier:(NSString *)identifier resultIdentifier:(NSString * _Nullable)resultIdentifier imageInfo:(id<AssessmentModelImageInfo> _Nullable)imageInfo fullInstructionsOnly:(BOOL)fullInstructionsOnly __attribute__((swift_name("doCopy(identifier:resultIdentifier:imageInfo:fullInstructionsOnly:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (AssessmentModelFormattedValue<AssessmentModelInt *> *)validateNumber:(AssessmentModelInt * _Nullable)number __attribute__((swift_name("validate(number:)")));
@property (readonly) int32_t maximumFractionDigits __attribute__((swift_name("maximumFractionDigits")));
...
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValueForValue:(AssessmentModelInt * _Nullable)value __attribute__((swift_name("jsonValueFor(value:)")));
- (AssessmentModelFormattedValue<NSString *> *)localizedStringForValue:(AssessmentModelInt * _Nullable)value __attribute__((swift_name("localizedStringFor(value:)")));
...
- (AssessmentModelInt * _Nullable)valueForJsonValue:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)jsonValue __attribute__((swift_name("valueFor(jsonValue:)")));
- (AssessmentModelFormattedValue<AssessmentModelInt *> * _Nullable)valueForText:(NSString *)text __attribute__((swift_name("valueFor(text:)")));
@end;
...
- (AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)decodeObjectAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("decodeObject()")));
@property AssessmentModelKotlinx_serialization_runtimeJson *jsonCoder __attribute__((swift_name("jsonCoder")));
@property (readonly) NSString *jsonString __attribute__((swift_name("jsonString")));
@end;
...
- (instancetype)initWithJsonElement:(AssessmentModelKotlinx_serialization_runtimeJsonElement *)jsonElement __attribute__((swift_name("init(jsonElement:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)encodeObjectAndReturnError:(NSError * _Nullable * _Nullable)error __attribute__((swift_name("encodeObject()")));
@property AssessmentModelKotlinx_serialization_runtimeJson *jsonCoder __attribute__((swift_name("jsonCoder")));
@property (readonly) AssessmentModelKotlinx_serialization_runtimeJsonElement *jsonElement __attribute__((swift_name("jsonElement")));
@end;
...
- (instancetype)initWithIdentifier:(NSString *)identifier inputItems:(NSArray<id<AssessmentModelInputItem>> *)inputItems resultIdentifier:(NSString * _Nullable)resultIdentifier sequenceSeparator:(NSString * _Nullable)sequenceSeparator skipCheckbox:(id<AssessmentModelSkipCheckboxInputItem> _Nullable)skipCheckbox __attribute__((swift_name("init(identifier:inputItems:resultIdentifier:sequenceSeparator:skipCheckbox:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (id<AssessmentModelSkipCheckboxInputItem> _Nullable)component5 __attribute__((swift_name("component5()")));
- (AssessmentModelMultipleInputQuestionObject *)doCopyIdentifier:(NSString *)identifier inputItems:(NSArray<id<AssessmentModelInputItem>> *)inputItems resultIdentifier:(NSString * _Nullable)resultIdentifier sequenceSeparator:(NSString * _Nullable)sequenceSeparator skipCheckbox:(id<AssessmentModelSkipCheckboxInputItem> _Nullable)skipCheckbox __attribute__((swift_name("doCopy(identifier:inputItems:resultIdentifier:sequenceSeparator:skipCheckbox:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *identifier __attribute__((swift_name("identifier")));
...
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializerTypeParamsSerializers:(AssessmentModelKotlinArray<id<AssessmentModelKotlinx_serialization_runtimeKSerializer>> *)typeParamsSerializers __attribute__((swift_name("serializer(typeParamsSerializers:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializerTypeSerial0:(id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)typeSerial0 __attribute__((swift_name("serializer(typeSerial0:)")));
...
- (int32_t)compareToOther:(AssessmentModelNumberFormatOptionsStyle *)other __attribute__((swift_name("compareTo(other:)")));
@property (readonly) NSString * _Nullable serialName __attribute__((swift_name("serialName")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NumberFormatOptionsStyleCompanion")))
@interface AssessmentModelNumberFormatOptionsStyleCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelNumberFormatOptionsStyle *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelNumberFormatOptionsStyle *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelNumberFormatOptionsStyle *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelNumberFormatOptionsStyle *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (instancetype)initWithIdentifier:(NSString *)identifier scoringResultPath:(AssessmentModelIdentifierPath * _Nullable)scoringResultPath resultTitle:(NSString * _Nullable)resultTitle imageInfo:(id<AssessmentModelImageInfo> _Nullable)imageInfo resultIdentifier:(NSString * _Nullable)resultIdentifier __attribute__((swift_name("init(identifier:scoringResultPath:resultTitle:imageInfo:resultIdentifier:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier children:(NSArray<id<AssessmentModelNode>> *)children resultIdentifier:(NSString * _Nullable)resultIdentifier backgroundActions:(NSArray<id<AssessmentModelAsyncActionConfiguration>> *)backgroundActions __attribute__((swift_name("init(identifier:children:resultIdentifier:backgroundActions:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSArray<id<AssessmentModelNode>> *)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSArray<id<AssessmentModelAsyncActionConfiguration>> *)component4 __attribute__((swift_name("component4()")));
- (AssessmentModelSectionObject *)doCopyIdentifier:(NSString *)identifier children:(NSArray<id<AssessmentModelNode>> *)children resultIdentifier:(NSString * _Nullable)resultIdentifier backgroundActions:(NSArray<id<AssessmentModelAsyncActionConfiguration>> *)backgroundActions __attribute__((swift_name("doCopy(identifier:children:resultIdentifier:backgroundActions:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
- (AssessmentModelSectionObject *)unpackFileLoader:(id<AssessmentModelFileLoader>)fileLoader resourceInfo:(id<AssessmentModelResourceInfo>)resourceInfo jsonCoder:(AssessmentModelKotlinx_serialization_runtimeJson *)jsonCoder __attribute__((swift_name("unpack(fileLoader:resourceInfo:jsonCoder:)")));
@property (readonly) NSArray<id<AssessmentModelAsyncActionConfiguration>> *backgroundActions __attribute__((swift_name("backgroundActions")));
@property (readonly) NSArray<id<AssessmentModelNode>> *children __attribute__((swift_name("children")));
@property (readonly) NSString *identifier __attribute__((swift_name("identifier")));
@property (readonly) NSString * _Nullable resultIdentifier __attribute__((swift_name("resultIdentifier")));
...
@property (readonly, getter=default) AssessmentModelKotlinx_serialization_runtimeJson *default_ __attribute__((swift_name("default_")));
@end;
...
@property (readonly, getter=default) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> default_ __attribute__((swift_name("default_")));
@end;
...
- (instancetype)initWithIdentifier:(NSString *)identifier inputItem:(id<AssessmentModelInputItem>)inputItem resultIdentifier:(NSString * _Nullable)resultIdentifier skipCheckbox:(id<AssessmentModelSkipCheckboxInputItem> _Nullable)skipCheckbox __attribute__((swift_name("init(identifier:inputItem:resultIdentifier:skipCheckbox:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (AssessmentModelSimpleQuestionObject *)doCopyIdentifier:(NSString *)identifier inputItem:(id<AssessmentModelInputItem>)inputItem resultIdentifier:(NSString * _Nullable)resultIdentifier skipCheckbox:(id<AssessmentModelSkipCheckboxInputItem> _Nullable)skipCheckbox __attribute__((swift_name("doCopy(identifier:inputItem:resultIdentifier:skipCheckbox:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *identifier __attribute__((swift_name("identifier")));
...
- (instancetype)initWithFieldLabel:(NSString *)fieldLabel value:(AssessmentModelKotlinx_serialization_runtimeJsonElement *)value __attribute__((swift_name("init(fieldLabel:value:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (AssessmentModelKotlinx_serialization_runtimeJsonElement *)component2 __attribute__((swift_name("component2()")));
- (AssessmentModelSkipCheckboxInputItemObject *)doCopyFieldLabel:(NSString *)fieldLabel value:(AssessmentModelKotlinx_serialization_runtimeJsonElement *)value __attribute__((swift_name("doCopy(fieldLabel:value:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *fieldLabel __attribute__((swift_name("fieldLabel")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier items:(NSArray<NSString *> *)items resultIdentifier:(NSString * _Nullable)resultIdentifier singleAnswer:(BOOL)singleAnswer uiHint:(AssessmentModelUIHint *)uiHint __attribute__((swift_name("init(identifier:items:resultIdentifier:singleAnswer:uiHint:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (AssessmentModelStringChoiceQuestionObject *)doCopyIdentifier:(NSString *)identifier items:(NSArray<NSString *> *)items resultIdentifier:(NSString * _Nullable)resultIdentifier singleAnswer:(BOOL)singleAnswer uiHint:(AssessmentModelUIHint *)uiHint __attribute__((swift_name("doCopy(identifier:items:resultIdentifier:singleAnswer:uiHint:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) AssessmentModelBaseType *baseType __attribute__((swift_name("baseType")));
...
- (instancetype)initWithIdentifier:(NSString *)identifier resourceName:(NSString *)resourceName versionString:(NSString * _Nullable)versionString resultIdentifier:(NSString * _Nullable)resultIdentifier __attribute__((swift_name("init(identifier:resourceName:versionString:resultIdentifier:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (AssessmentModelTransformableNodeObject *)doCopyIdentifier:(NSString *)identifier resourceName:(NSString *)resourceName versionString:(NSString * _Nullable)versionString resultIdentifier:(NSString * _Nullable)resultIdentifier __attribute__((swift_name("doCopy(identifier:resourceName:versionString:resultIdentifier:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *identifier __attribute__((swift_name("identifier")));
...
- (int32_t)compareToOther:(AssessmentModelFinishedReason *)other __attribute__((swift_name("compareTo(other:)")));
@end;
...
@interface AssessmentModelIdentifierPathCompanion : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (AssessmentModelIdentifierPath *)deserializeDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (AssessmentModelIdentifierPath *)patchDecoder:(id<AssessmentModelKotlinx_serialization_runtimeDecoder>)decoder old:(AssessmentModelIdentifierPath *)old __attribute__((swift_name("patch(decoder:old:)")));
- (void)serializeEncoder:(id<AssessmentModelKotlinx_serialization_runtimeEncoder>)encoder value:(AssessmentModelIdentifierPath *)value __attribute__((swift_name("serialize(encoder:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("serializer()")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
- (int32_t)compareToOther:(AssessmentModelNavigationPointDirection *)other __attribute__((swift_name("compareTo(other:)")));
@end;
...
@interface AssessmentModelKotlinx_serialization_runtimeJsonElement : AssessmentModelBase
...
@property (readonly) NSArray<AssessmentModelKotlinx_serialization_runtimeJsonElement *> *jsonArray __attribute__((swift_name("jsonArray")));
@property (readonly) AssessmentModelKotlinx_serialization_runtimeJsonNull *jsonNull __attribute__((swift_name("jsonNull")));
@property (readonly) NSDictionary<NSString *, AssessmentModelKotlinx_serialization_runtimeJsonElement *> *jsonObject __attribute__((swift_name("jsonObject")));
@property (readonly) AssessmentModelKotlinx_serialization_runtimeJsonPrimitive *primitive __attribute__((swift_name("primitive")));
@end;

@interface AssessmentModelKotlinx_serialization_runtimeJsonElement (Extensions)
- (BOOL)compareToValue:(AssessmentModelKotlinx_serialization_runtimeJsonElement * _Nullable)value operator:(AssessmentModelSurveyRuleOperator *)operator_ accuracy:(double)accuracy __attribute__((swift_name("compareTo(value:operator:accuracy:)")));
@end;
...
@property (class, readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> answerTypeSerializersModule __attribute__((swift_name("answerTypeSerializersModule")));
@end;
...
@property (class, readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> asyncActionSerializersModule __attribute__((swift_name("asyncActionSerializersModule")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ButtonsKt")))
@interface AssessmentModelButtonsKt : AssessmentModelBase
@property (class, readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> buttonSerializersModule __attribute__((swift_name("buttonSerializersModule")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FileAssessmentProviderKt")))
@interface AssessmentModelFileAssessmentProviderKt : AssessmentModelBase
@property (class, readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> fileProviderSerializersModule __attribute__((swift_name("fileProviderSerializersModule")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ImageKt")))
@interface AssessmentModelImageKt : AssessmentModelBase
@property (class, readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> imageSerializersModule __attribute__((swift_name("imageSerializersModule")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("InputItemsKt")))
@interface AssessmentModelInputItemsKt : AssessmentModelBase
@property (class, readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> inputItemSerializersModule __attribute__((swift_name("inputItemSerializersModule")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NodesKt")))
@interface AssessmentModelNodesKt : AssessmentModelBase
@property (class, readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> nodeSerializersModule __attribute__((swift_name("nodeSerializersModule")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ResultsKt")))
@interface AssessmentModelResultsKt : AssessmentModelBase
@property (class, readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> resultSerializersModule __attribute__((swift_name("resultSerializersModule")));
@end;
...
@protocol AssessmentModelKotlinx_serialization_runtimeSerialFormat
@required
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> context __attribute__((swift_name("context")));
@end;

__attribute__((swift_name("Kotlinx_serialization_runtimeStringFormat")))
@protocol AssessmentModelKotlinx_serialization_runtimeStringFormat <AssessmentModelKotlinx_serialization_runtimeSerialFormat>
@required
- (id _Nullable)parseDeserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("parse(deserializer:string:)")));
- (NSString *)stringifySerializer:(id<AssessmentModelKotlinx_serialization_runtimeSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("stringify(serializer:value:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_runtimeJson")))
@interface AssessmentModelKotlinx_serialization_runtimeJson : AssessmentModelBase <AssessmentModelKotlinx_serialization_runtimeStringFormat>
- (instancetype)initWithBlock:(void (^)(AssessmentModelKotlinx_serialization_runtimeJsonBuilder *))block __attribute__((swift_name("init(block:)"))) __attribute__((objc_designated_initializer));
...
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (instancetype)initWithConfiguration:(AssessmentModelKotlinx_serialization_runtimeJsonConfiguration *)configuration context:(id<AssessmentModelKotlinx_serialization_runtimeSerialModule>)context __attribute__((swift_name("init(configuration:context:)"))) __attribute__((objc_designated_initializer));
- (id _Nullable)fromJsonDeserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer json:(AssessmentModelKotlinx_serialization_runtimeJsonElement *)json __attribute__((swift_name("fromJson(deserializer:json:)")));
- (id)fromJsonTree:(AssessmentModelKotlinx_serialization_runtimeJsonElement *)tree __attribute__((swift_name("fromJson(tree:)")));
- (id _Nullable)parseDeserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer string:(NSString *)string __attribute__((swift_name("parse(deserializer:string:)")));
- (AssessmentModelKotlinx_serialization_runtimeJsonElement *)parseJsonString:(NSString *)string __attribute__((swift_name("parseJson(string:)")));
- (NSString *)stringifySerializer:(id<AssessmentModelKotlinx_serialization_runtimeSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("stringify(serializer:value:)")));
- (AssessmentModelKotlinx_serialization_runtimeJsonElement *)toJsonValue:(id)value __attribute__((swift_name("toJson(value:)")));
- (AssessmentModelKotlinx_serialization_runtimeJsonElement *)toJsonSerializer:(id<AssessmentModelKotlinx_serialization_runtimeSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("toJson(serializer:value:)")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> context __attribute__((swift_name("context")));
@end;

__attribute__((swift_name("Kotlinx_serialization_runtimeEncoder")))
@protocol AssessmentModelKotlinx_serialization_runtimeEncoder
@required
- (id<AssessmentModelKotlinx_serialization_runtimeCompositeEncoder>)beginCollectionDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor collectionSize:(int32_t)collectionSize typeSerializers:(AssessmentModelKotlinArray<id<AssessmentModelKotlinx_serialization_runtimeKSerializer>> *)typeSerializers __attribute__((swift_name("beginCollection(descriptor:collectionSize:typeSerializers:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeCompositeEncoder>)beginStructureDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor typeSerializers:(AssessmentModelKotlinArray<id<AssessmentModelKotlinx_serialization_runtimeKSerializer>> *)typeSerializers __attribute__((swift_name("beginStructure(descriptor:typeSerializers:)")));
- (void)encodeBooleanValue:(BOOL)value __attribute__((swift_name("encodeBoolean(value:)")));
- (void)encodeByteValue:(int8_t)value __attribute__((swift_name("encodeByte(value:)")));
- (void)encodeCharValue:(unichar)value __attribute__((swift_name("encodeChar(value:)")));
- (void)encodeDoubleValue:(double)value __attribute__((swift_name("encodeDouble(value:)")));
- (void)encodeEnumEnumDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)enumDescriptor index:(int32_t)index __attribute__((swift_name("encodeEnum(enumDescriptor:index:)")));
- (void)encodeFloatValue:(float)value __attribute__((swift_name("encodeFloat(value:)")));
- (void)encodeIntValue:(int32_t)value __attribute__((swift_name("encodeInt(value:)")));
- (void)encodeLongValue:(int64_t)value __attribute__((swift_name("encodeLong(value:)")));
- (void)encodeNotNullMark __attribute__((swift_name("encodeNotNullMark()")));
- (void)encodeNull __attribute__((swift_name("encodeNull()")));
- (void)encodeNullableSerializableValueSerializer:(id<AssessmentModelKotlinx_serialization_runtimeSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeNullableSerializableValue(serializer:value:)")));
- (void)encodeSerializableValueSerializer:(id<AssessmentModelKotlinx_serialization_runtimeSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeSerializableValue(serializer:value:)")));
...
@protocol AssessmentModelKotlinx_serialization_runtimeSerialDescriptor
@required
...
- (id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)getElementDescriptorIndex:(int32_t)index __attribute__((swift_name("getElementDescriptor(index:)")));
- (int32_t)getElementIndexName:(NSString *)name __attribute__((swift_name("getElementIndex(name:)")));
- (NSString *)getElementNameIndex:(int32_t)index __attribute__((swift_name("getElementName(index:)")));
- (NSArray<id<AssessmentModelKotlinAnnotation>> *)getEntityAnnotations __attribute__((swift_name("getEntityAnnotations()"))) __attribute__((deprecated("Deprecated in the favour of 'annotations' property")));
...
@property (readonly) AssessmentModelKotlinx_serialization_runtimeSerialKind *kind __attribute__((swift_name("kind")));
...
@protocol AssessmentModelKotlinx_serialization_runtimeDecoder
@required
- (id<AssessmentModelKotlinx_serialization_runtimeCompositeDecoder>)beginStructureDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor typeParams:(AssessmentModelKotlinArray<id<AssessmentModelKotlinx_serialization_runtimeKSerializer>> *)typeParams __attribute__((swift_name("beginStructure(descriptor:typeParams:)")));
- (BOOL)decodeBoolean __attribute__((swift_name("decodeBoolean()")));
- (int8_t)decodeByte __attribute__((swift_name("decodeByte()")));
- (unichar)decodeChar __attribute__((swift_name("decodeChar()")));
- (double)decodeDouble __attribute__((swift_name("decodeDouble()")));
- (int32_t)decodeEnumEnumDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)enumDescriptor __attribute__((swift_name("decodeEnum(enumDescriptor:)")));
...
- (id _Nullable)decodeNullableSerializableValueDeserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer __attribute__((swift_name("decodeNullableSerializableValue(deserializer:)")));
- (id _Nullable)decodeSerializableValueDeserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer __attribute__((swift_name("decodeSerializableValue(deserializer:)")));
- (int16_t)decodeShort __attribute__((swift_name("decodeShort()")));
- (NSString *)decodeString __attribute__((swift_name("decodeString()")));
- (void)decodeUnit __attribute__((swift_name("decodeUnit()")));
- (id _Nullable)updateNullableSerializableValueDeserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer old:(id _Nullable)old __attribute__((swift_name("updateNullableSerializableValue(deserializer:old:)")));
- (id _Nullable)updateSerializableValueDeserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer old:(id _Nullable)old __attribute__((swift_name("updateSerializableValue(deserializer:old:)")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> context __attribute__((swift_name("context")));
@property (readonly) AssessmentModelKotlinx_serialization_runtimeUpdateMode *updateMode __attribute__((swift_name("updateMode")));
@end;

__attribute__((swift_name("Kotlinx_serialization_runtimeSerialKind")))
@interface AssessmentModelKotlinx_serialization_runtimeSerialKind : AssessmentModelBase
- (NSString *)description __attribute__((swift_name("description()")));
@end;

__attribute__((swift_name("Kotlinx_serialization_runtimeSerialModule")))
@protocol AssessmentModelKotlinx_serialization_runtimeSerialModule
@required
- (void)dumpToCollector:(id<AssessmentModelKotlinx_serialization_runtimeSerialModuleCollector>)collector __attribute__((swift_name("dumpTo(collector:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer> _Nullable)getContextualKclass:(id<AssessmentModelKotlinKClass>)kclass __attribute__((swift_name("getContextual(kclass:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer> _Nullable)getPolymorphicBaseClass:(id<AssessmentModelKotlinKClass>)baseClass value:(id)value __attribute__((swift_name("getPolymorphic(baseClass:value:)")));
- (id<AssessmentModelKotlinx_serialization_runtimeKSerializer> _Nullable)getPolymorphicBaseClass:(id<AssessmentModelKotlinKClass>)baseClass serializedClassName:(NSString *)serializedClassName __attribute__((swift_name("getPolymorphic(baseClass:serializedClassName:)")));
@end;
...
@interface AssessmentModelKotlinx_serialization_runtimeJsonPrimitive : AssessmentModelKotlinx_serialization_runtimeJsonElement
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) BOOL boolean __attribute__((swift_name("boolean")));
@property (readonly) AssessmentModelBoolean * _Nullable booleanOrNull __attribute__((swift_name("booleanOrNull")));
...
@property (readonly) AssessmentModelDouble * _Nullable doubleOrNull __attribute__((swift_name("doubleOrNull")));
@property (readonly, getter=float) float float_ __attribute__((swift_name("float_")));
@property (readonly) AssessmentModelFloat * _Nullable floatOrNull __attribute__((swift_name("floatOrNull")));
@property (readonly, getter=int) int32_t int_ __attribute__((swift_name("int_")));
@property (readonly) AssessmentModelInt * _Nullable intOrNull __attribute__((swift_name("intOrNull")));
@property (readonly, getter=long) int64_t long_ __attribute__((swift_name("long_")));
@property (readonly) AssessmentModelLong * _Nullable longOrNull __attribute__((swift_name("longOrNull")));
@property (readonly) AssessmentModelKotlinx_serialization_runtimeJsonPrimitive *primitive __attribute__((swift_name("primitive")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Kotlinx_serialization_runtimeJsonNull")))
@interface AssessmentModelKotlinx_serialization_runtimeJsonNull : AssessmentModelKotlinx_serialization_runtimeJsonPrimitive
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
@interface AssessmentModelKotlinx_serialization_runtimeJsonBuilder : AssessmentModelBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (AssessmentModelKotlinx_serialization_runtimeJsonConfiguration *)buildConfiguration __attribute__((swift_name("buildConfiguration()")));
- (id<AssessmentModelKotlinx_serialization_runtimeSerialModule>)buildModule __attribute__((swift_name("buildModule()")));
...
@property id<AssessmentModelKotlinx_serialization_runtimeSerialModule> serialModule __attribute__((swift_name("serialModule")));
...
@protocol AssessmentModelKotlinx_serialization_runtimeCompositeEncoder
@required
- (void)encodeBooleanElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(BOOL)value __attribute__((swift_name("encodeBooleanElement(descriptor:index:value:)")));
- (void)encodeByteElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(int8_t)value __attribute__((swift_name("encodeByteElement(descriptor:index:value:)")));
- (void)encodeCharElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(unichar)value __attribute__((swift_name("encodeCharElement(descriptor:index:value:)")));
- (void)encodeDoubleElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(double)value __attribute__((swift_name("encodeDoubleElement(descriptor:index:value:)")));
- (void)encodeFloatElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(float)value __attribute__((swift_name("encodeFloatElement(descriptor:index:value:)")));
- (void)encodeIntElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(int32_t)value __attribute__((swift_name("encodeIntElement(descriptor:index:value:)")));
- (void)encodeLongElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(int64_t)value __attribute__((swift_name("encodeLongElement(descriptor:index:value:)")));
- (void)encodeNonSerializableElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(id)value __attribute__((swift_name("encodeNonSerializableElement(descriptor:index:value:)"))) __attribute__((unavailable("This method is deprecated for removal. Please remove it from your implementation and delegate to default method instead")));
- (void)encodeNullableSerializableElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index serializer:(id<AssessmentModelKotlinx_serialization_runtimeSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeNullableSerializableElement(descriptor:index:serializer:value:)")));
- (void)encodeSerializableElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index serializer:(id<AssessmentModelKotlinx_serialization_runtimeSerializationStrategy>)serializer value:(id _Nullable)value __attribute__((swift_name("encodeSerializableElement(descriptor:index:serializer:value:)")));
- (void)encodeShortElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(int16_t)value __attribute__((swift_name("encodeShortElement(descriptor:index:value:)")));
- (void)encodeStringElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index value:(NSString *)value __attribute__((swift_name("encodeStringElement(descriptor:index:value:)")));
- (void)encodeUnitElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("encodeUnitElement(descriptor:index:)")));
- (void)endStructureDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor __attribute__((swift_name("endStructure(descriptor:)")));
- (BOOL)shouldEncodeElementDefaultDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("shouldEncodeElementDefault(descriptor:index:)")));
@property (readonly) id<AssessmentModelKotlinx_serialization_runtimeSerialModule> context __attribute__((swift_name("context")));
@end;
...
@protocol AssessmentModelKotlinx_serialization_runtimeCompositeDecoder
@required
- (BOOL)decodeBooleanElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeBooleanElement(descriptor:index:)")));
- (int8_t)decodeByteElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeByteElement(descriptor:index:)")));
- (unichar)decodeCharElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeCharElement(descriptor:index:)")));
- (int32_t)decodeCollectionSizeDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor __attribute__((swift_name("decodeCollectionSize(descriptor:)")));
- (double)decodeDoubleElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeDoubleElement(descriptor:index:)")));
- (int32_t)decodeElementIndexDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor __attribute__((swift_name("decodeElementIndex(descriptor:)")));
- (float)decodeFloatElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeFloatElement(descriptor:index:)")));
- (int32_t)decodeIntElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeIntElement(descriptor:index:)")));
- (int64_t)decodeLongElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeLongElement(descriptor:index:)")));
- (id _Nullable)decodeNullableSerializableElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index deserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer __attribute__((swift_name("decodeNullableSerializableElement(descriptor:index:deserializer:)")));
- (BOOL)decodeSequentially __attribute__((swift_name("decodeSequentially()")));
- (id _Nullable)decodeSerializableElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index deserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer __attribute__((swift_name("decodeSerializableElement(descriptor:index:deserializer:)")));
- (int16_t)decodeShortElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeShortElement(descriptor:index:)")));
- (NSString *)decodeStringElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeStringElement(descriptor:index:)")));
- (void)decodeUnitElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index __attribute__((swift_name("decodeUnitElement(descriptor:index:)")));
- (void)endStructureDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor __attribute__((swift_name("endStructure(descriptor:)")));
- (id _Nullable)updateNullableSerializableElementDescriptor:(id<AssessmentModelKotlinx_serialization_runtimeSerialDescriptor>)descriptor index:(int32_t)index deserializer:(id<AssessmentModelKotlinx_serialization_runtimeDeserializationStrategy>)deserializer old:(id _Nullable)old __attribute__((swift_name("updateNullableSerializableElement(descriptor:index:deserializer:old:)")));
...
@interface AssessmentModelKotlinx_serialization_runtimeUpdateMode : AssessmentModelKotlinEnum<AssessmentModelKotlinx_serialization_runtimeUpdateMode *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) AssessmentModelKotlinx_serialization_runtimeUpdateMode *banned __attribute__((swift_name("banned")));
@property (class, readonly) AssessmentModelKotlinx_serialization_runtimeUpdateMode *overwrite __attribute__((swift_name("overwrite")));
@property (class, readonly) AssessmentModelKotlinx_serialization_runtimeUpdateMode *update __attribute__((swift_name("update")));
- (int32_t)compareToOther:(AssessmentModelKotlinx_serialization_runtimeUpdateMode *)other __attribute__((swift_name("compareTo(other:)")));
@end;

__attribute__((swift_name("Kotlinx_serialization_runtimeSerialModuleCollector")))
@protocol AssessmentModelKotlinx_serialization_runtimeSerialModuleCollector
@required
- (void)contextualKClass:(id<AssessmentModelKotlinKClass>)kClass serializer:(id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)serializer __attribute__((swift_name("contextual(kClass:serializer:)")));
- (void)polymorphicBaseClass:(id<AssessmentModelKotlinKClass>)baseClass actualClass:(id<AssessmentModelKotlinKClass>)actualClass actualSerializer:(id<AssessmentModelKotlinx_serialization_runtimeKSerializer>)actualSerializer __attribute__((swift_name("polymorphic(baseClass:actualClass:actualSerializer:)")));
@end;
